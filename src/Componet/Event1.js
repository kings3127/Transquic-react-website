  ...
  return (
    <div>
      ...
      <Box display="flex" justifyContent="center" alignItems="center" style={{ height: '80vh' }}>
        <Paper style={{ padding:20, height:'70vh', width:'20%', margin:"20px auto", backgroundColor: 'rgba(200, 200, 200, 0.2)', justifyContent:'center', textAlign:'center', border: '2px solid black' }}>
